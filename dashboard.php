...
$admin_sql = "SELECT COUNT(*) as admin_count FROM account WHERE Role = 'admin'";
$admin_result = $conn->query($admin_sql);
$admin_count = ($admin_result->num_rows > 0) ? $admin_result->fetch_assoc()['admin_count'] : 0;
...
@media (max-width: 768px) {
            .table-data, .order, .chart-container {
